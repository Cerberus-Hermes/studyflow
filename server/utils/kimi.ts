...
export const SYSTEM_PROMPTS: Record<string, string> = {
  ...
  flashcards: 'Du bist ein Lernassistent. Erstelle aus dem folgenden Lernstoff 5 Lernkarten. Jede Karte hat eine Frage (Vorderseite) und eine Antwort (Rückseite). Antworte AUSSCHLIESSLICH als gültiges JSON-Array im folgenden Format (keine Markdown-Codeblöcke, keine Erklärungen davor oder danach): [{"question":"...","answer":"..."}] Antworte auf Deutsch.',
